...
recall                = 0;                % number of trials in recall phase

% Your conditions in the study, which is typically the base name of all
% your data file.
conditions  = {'Arc30inst', 'RecogS1', 'RecSham', 'RecogM1', 'RecallS1', 'RecallSham', 'RecallM1'};
...
cond      = lower(input(['Please enter the condition of your study (arc30i):', ...
...
while ~(strcmp(cond, 'arc30i') || strcmp(cond, 'rs1') || strcmp(cond, 'rm1') || strcmp(cond, 'rs') || strcmp(cond, 'rls1') || strcmp(cond, 'rlm1') || strcmp(cond, 'rls'))
    fprintf('\nIncorrect input... Please try again!!!');
    cond  = input('\nPlease enter the condition of your study  (arc30i/rs1/rm1/rs/rls1/rlm1/rls): ', 's');
end
...
save_name = [directory, cond, '_Sub', SN, '_Scored'];
