...
function varargout=shadedErrorBar(x, y, errBar, lineProps, transparent, mainLine, hatch, hatchSetting)
%
...
%
%
% mainLine - [optional, 1 by default] if == 0 the main line of the plot
%             is made hidden.
%
%
%
...
if hatch == 1
    hatchfill(H.patch, hatchSetting{1}, hatchSetting{2}, hatchSetting{3}, patchColor, edgeColor, hatchSetting{4});
end
...
if mainLine == 1
    H.mainLine=plot(x,y,lineProps{:}, 'color', col+(1-col)*0.65);
end
